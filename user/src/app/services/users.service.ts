...
export class UsersService {
  ...
  getUser() {
    ...
    return this.http.get<any>(`${this.URI}/Controller/${localStorage.getItem('id')}`, { headers })
  }

  getUserconvalidation(ww: string, campo: string) {
    // console.log(ww)
    return this.http.post<any>(environment.apiURL + '/api/users/ControllerConvalidation', { ww, campo })
    // return this.http.get<any>(`${this.URI}/ControllerConvalidation/`, {ww})
  }
  ...
  getUserTeacher(id: string) {
    ...
    //console.log(localStorage.getItem('id'))
    return this.http.get<any>(`${this.URI}/Controller/${id}`, { headers })
  }
