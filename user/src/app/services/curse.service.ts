...
<li>Esforzarse por obtener la mayor calidad en todo lo que emprende, intentando alcanzar resultados positivos.</li>
  ...
  getcurseuseronly(id: string, ciclo: string, mencion: string) {
    console.log(ciclo,mencion,id)

    return this.http.get(`${environment.apiURL}/api/integer/Controllerintegeruser/${id}/${ciclo}/${mencion}`);
    //console.log(id)
  }
  /////////////////////////////
  ...
  */
  ...
  saveencuesta(idstudent: string, idteacher: string, idcurso: string, codigo: string, ciclo: string, mencion: string, w1: {}, w2: {}, w3: {}, w4: {}, w5: {}, w6: {}, w7: {}, w8: {}, w9: {}, w10: {}, w11: {}, w12: {}, w13: {}, w14: {}, w15: {}, w16: {}, w17: {}, w18: {}, w19: {}, w20: {}) {
    console.log( w1, w2, w3 , w4 , w5 , w6 , w7, w8, w9)
    return this.http.post<any>(`${environment.apiURL}/api/integer/Controller/encuesta`, { idstudent, idteacher, idcurso, codigo, ciclo, mencion, w1, w2, w3, w4, w5, w6, w7, w8, w9, w10, w11, w12, w13, w14, w15, w16, w17, w18, w19, w20 })
  }



  encuestadelete(idinteger: string) {
    // console.log(idinteger)
    return this.http.delete(`${environment.apiURL}/api/integer/Controller/encuesta/${idinteger}`);
  }
  ...
  getencuesta(id: string,ciclo:string,mencion:string) {
    return this.http.get(`${environment.apiURL}/api/integer/Controller/encuesta/${id}/${ciclo}/${mencion}`);
  }
  ...
  Getcursesourcesonlycicle(ciclo: string, mencion: string, user: string) {
    console.log(ciclo,mencion,user)
  ...
  getFirstAveragesonlyoneteacher(user: string, year: string) {
    return this.http.get(`${environment.apiURL}/api/AVERAGE/getFirstAveragesonlyoneteacher/${user}/${year}`);
  }
