...
//find insensitive
db.users.find({"name": {$regex: 'floriano', $options: "$i"}})
//descargar
...
db.users.updateMany({ rol:"3", "mencion": { $eq: null }, "email": {$regex: 'esfapa', $options: "$i"} }, {$set:{mencion:"ED"}})
